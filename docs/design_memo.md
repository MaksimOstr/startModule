...
- Total order value is calculated as price * quantity * tax
...
- Negative tax rate -> throws 'Tax rate cannot be negative'
...
- Tested error handling for invalid tax rate number
